...
%\section{Interacting with the food}
%Having food that does nothing is not interesting, we want to be able to do stuff with it. When an agent touches a food source he should pick it up and carry it for a while, before dropping it again.

%All agents are part of a group, just like the food should be. 