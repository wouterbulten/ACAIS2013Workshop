...
\instruct{Add the line above to the \textit{\_\_init\_\_} function of the agent}
...
\instruct{Add the function above to the RandomAgent class}
...
\instruct{Add the line above to the \textit{iterate} function}
